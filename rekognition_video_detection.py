...
def run_reko_on_s3_video(video_name):
    rekognition_client = boto3.client('rekognition')    
    s3_object = boto3.resource('s3').Object('1hackathonbucket',video_name)
    video = RekognitionVideo.from_bucket(s3_object, rekognition_client)
